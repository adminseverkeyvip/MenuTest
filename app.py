...
REGION_CONFIG = {
    ...
    'BR': {'region_code': 'BR', 'language': 'en', 'source': 'mb'},
    'US': {'region_code': 'US', 'language': 'en', 'source': 'mb'},
    'NA': {'region_code': 'NA', 'language': 'en', 'source': 'mb'},
    'SAC': {'region_code': 'SAC', 'language': 'en', 'source': 'mb'},
    'PK': {'region_code': 'PK', 'language': 'en', 'source': 'mb'},
    'SG': {'region_code': 'SG', 'language': 'en', 'source': 'mb'},
    'BD': {'region_code': 'BD', 'language': 'en', 'source': 'mb'},
    'VN': {'region_code': 'VN', 'language': 'en', 'source': 'mb'},
    'ME': {'region_code': 'ME', 'language': 'en', 'source': 'mb'},
    'EU': {'region_code': 'EU', 'language': 'en', 'source': 'mb'},
    'ID': {'region_code': 'ID', 'language': 'en', 'source': 'mb'},
    'TH': {'region_code': 'TH', 'language': 'en', 'source': 'mb'},
    'TW': {'region_code': 'TW', 'language': 'en', 'source': 'mb'},
    'RU': {'region_code': 'RU', 'language': 'en', 'source': 'mb'},
}
